          ...
          <div className="relative grid gap-12 lg:gap-20 lg:grid-cols-[1.1fr,1fr] items-start">
            <div className="space-y-10">
              <div className="space-y-3">
                ...
                <p className="text-sm sm:text-base text-gray-300 max-w-xl leading-relaxed">
                  Можно сразу прислать демо или референсы — так быстрее станет
                  понятно, что нужно по звуку. Если вы только на стадии идеи —
                  просто расскажите, что хотите сделать.
                </p>
              </div>
            ...
            >
              ...
              <p className="text-sm sm:text-base text-gray-300 mb-6 leading-relaxed">
                Оставьте контакты и пару строк о задаче — вернёмся с
                предложением по формату и ближайшим свободным слотам.
              </p>
          ...
          <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-14 md:grid-cols-2">
            <div className="space-y-8">
              ...
              <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
                Студия находится недалеко от центра Владивостока. Удобный
                подъезд, парковка и доступность транспорта. После брони мы
                пришлём точный маршрут и фото входа.
              </p>
              ...
              <div className="grid gap-6 sm:grid-cols-3 pt-6 text-xs sm:text-sm">
                <div className="space-y-1">
                  <p className="uppercase tracking-[0.18em] text-gray-500">
                    на авто
                  </p>
                  <p className="text-gray-400">
