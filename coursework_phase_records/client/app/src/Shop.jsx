          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24 flex flex-col lg:flex-row gap-12 lg:gap-20 items-end lg:items-center">
            <div className="flex-1 space-y-6 max-w-3xl">
              ...
              <p className="text-sm sm:text-base text-gray-200 max-w-2xl">
                Онлайн-бронирование доступно для записи вокала, а остальные
                услуги можно купить в один клик.
              </p>
        ...
        <section className="py-20 bg-gradient-to-b from-neutral-950 via-black/90 to-neutral-950 border-t border-white/5">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-6 text-[11px] text-gray-500 max-w-xl">
              После оформления заявки на плагины вы получите письмо с
              инструкцией по активации, лицензии и последующим обновлениям.
            </p>
          </div>
        </section>
      </main>
