    ...
    <div className="bg-black text-white font-sans min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <section className="relative w-full overflow-hidden border-b border-zinc-900/40 backdrop-blur-[1px]">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24">
            <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              <div className="space-y-4 max-w-2xl">
                ...
                <p className="text-sm sm:text-base text-gray-300">
                  Оставьте заявку: мы подтвердим время, уточним задачу и
                  подготовим зал под ваш проект.
                </p>
                ...
                {requestedService && requestedService !== "recording" && (
                  <p className="text-xs text-orange-300 bg-orange-500/10 border border-orange-500/30 rounded-xl px-4 py-3 max-w-xl">
                    Онлайн-бронирование доступно для записи вокала. Для других
                    услуг отправьте заявку через их карточку — мы вернёмся с
            ...
            <div className="mt-10 grid gap-8 lg:grid-cols-3">
              ...
              >
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="flex flex-col gap-2 text-sm text-gray-200">
                    ...
                    <div className="rounded-xl bg-black/60 border border-orange-500/30 px-4 py-3 text-sm flex items-center justify-between">
                      ...
                      <span className="text-[11px] uppercase tracking-[0.18em] text-orange-300">
                        только онлайн
                      </span>
                    </div>
                  </div>
                ...
                {submitted && !modalData && (
                  <p className="text-sm text-orange-300 bg-orange-500/10 border border-orange-500/30 rounded-xl px-4 py-3">
                    Заявка отправлена! Мы свяжемся с вами, чтобы подтвердить
                    время.
                  </p>
                )}
              </form>
              ...
              <div className="bg-zinc-900/70 border border-orange-500/20 rounded-2xl p-6 space-y-4 text-sm text-gray-200">
                ...
                <ul className="space-y-3 list-disc ml-4">
                  <li>
                    Фиксируем время и задачу, готовим оборудование заранее.
                  </li>
                  <li>
                    Присылаем вам адрес, чек-лист по подготовке и контакты
                    инженера.
                  </li>
                  <li>
                    После сессии можно сразу оставить трек на сведение или
                    мастеринг.
                  </li>
                  <li>
                    Если нужна другая услуга — отправьте заявку из её карточки,
                    мы подтвердим время отдельно.
                  </li>
                </ul>
            ...
            <div className="space-y-3 text-sm text-gray-200 bg-black/50 border border-orange-500/20 rounded-2xl p-4">
              ...
              <div className="flex justify-between gap-4">
                ...
                <span className="text-right">
                  {modalData.date || "не выбрана"}
                </span>
              </div>
              <div className="flex justify-between gap-4">
                <span className="text-gray-400">Время</span>
                <span className="text-right">
                  {modalData.time || "не выбрано"}
                </span>
              </div>
              <div className="flex justify-between gap-4">
