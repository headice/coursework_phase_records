...
const tracksBefore = [
  { title: "MMRecords - Mixed by Leslie", time: "0:23", src: "b1" },
  { title: "MMRecords - Mixed by Metro", time: "0:23", src: "b2" },
  { title: "MMRecords - Mixed by Metro", time: "0:39", src: "b3" },
  { title: "MMRecords - Mixed by Skrillex", time: "0:49", src: "b4" },
];

const tracksAfter = [
  { title: "MMRecords - Mixed by Leslie", time: "0:38", src: "a1" },
  { title: "MMRecords - Mixed by Metro", time: "0:36", src: "a2" },
  { title: "MMRecords - Mixed by Metro", time: "0:40", src: "a3" },
  { title: "MMRecords - Mixed by Skrillex", time: "1:02", src: "a4" },
];
...
export default function AudioPlayer() {
  ...
  const handleSeek = (e) => {
    ...
    if (!audioRef.current || isNaN(t)) return;
